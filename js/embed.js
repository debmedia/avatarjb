(function () {
  ...
  function mergeElementParams(baseParams, element) {
    ...
    var paramMappings = [
      ...
      { keys: ["hide_transcripts", "hide-transcripts", "hideTranscripts"], param: "hideTranscripts" },
      { keys: ["show_transcripts", "show-transcripts", "showTranscripts"], param: "showTranscripts" },
      { keys: ["show_buttons", "show-buttons", "showButtons"], param: "showButtons" },
